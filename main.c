...
"  -r <WIN> -Q          Show the windows Decorations\n" \
...
int main(int argc, char **argv) { /* {{{ */
  ...
  while ((opt = getopt(argc, argv, "FGVvhlupidjmxqQa:r:s:c:t:w:k:o:n:g:e:y:b:z:E:N:I:T:R:L:")) != -1) {
    missing_option = 0;
    switch (opt) {
      case 'F':
      ...
      case 'r':
        options.param_window = optarg;
        break;
      case 't': case 'e': case 'b': case 'N': case 'I': case 'T': case 'y': case 'L': case 'q': case 'Q':
